...
interface PreinstalledMarker {
    source: 'bostonclaw-preinstalled';
    slug: string;
    version: string;
    installedAt: string;
}
...
/**
 * Built-in skills bundled with Bostonclaw that should be pre-deployed to
...
const PREINSTALLED_MARKER_NAME = '.bostonclaw-preinstalled.json';
