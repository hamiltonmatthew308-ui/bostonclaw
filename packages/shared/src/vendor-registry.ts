...
export const VENDOR_REGISTRY: VendorInfo[] = [
  {
    ...
    name: 'QClaw',
    vendor: '腾讯',
    downloadUrl: 'https://qclaw-openclaw.com/zh/',
  ...
  },
  {
    ...
    name: 'ArkClaw',
    vendor: '字节跳动',
    downloadUrl: 'https://ark.claw.com/',
  ...
  },
  {
    ...
    name: 'AutoClaw',
    vendor: '智谱AI',
    downloadUrl: 'https://autoclaws.org/zh/',
  ...
  },
  {
    ...
    name: 'Kimi Claw',
    vendor: '月之暗面',
    downloadUrl: 'https://kimi-claw.com/',
  ...
  },
  {
    ...
    name: 'CoPaw',
    vendor: '阿里云',
    downloadUrl: 'https://copaw.agentscope.io/',
  ...
  },
  {
    ...
    name: 'DuClaw',
    vendor: '百度',
    downloadUrl: 'https://cloud.baidu.com/product/duclaw.html',
  ...
  },
  {
    ...
    name: 'MaxClaw',
    vendor: 'MiniMax',
    downloadUrl: 'https://maxclaw.ai/zh/',
