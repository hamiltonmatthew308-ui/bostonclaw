      ...
      <section className="editorial-section">
        <div className="content-frame">
          ...
          <div className="hero-metrics" style={{ marginTop: '48px' }}>
            <a href="#" className="metric-card reveal-card" style={{ textDecoration: 'none', color: 'inherit', cursor: 'pointer', display: 'block' }}>
          ...
          {LOBSTER_DOWNLOADS.map((d) => (
            <div key={`${d.platform}-${d.arch}`} className="editorial-rail reveal-card" style={{ alignItems: 'center' }}>
              ...
              <a href="#" className="secondary-link" style={{ padding: '4px 12px', fontSize: '11px' }}>下载</a>
            </div>
          ))}
        </div>
      </section>
